...
- (BMKAnnotationView*)getRouteAnnotationView:(BMKMapView *)mapview
{
    ...
    switch (_type) {
        ...
        case 7:
        {
            view = [mapview dequeueReusableAnnotationViewWithIdentifier:@"current_node"];
            if (view == nil) {
                view = [[BMKAnnotationView alloc]initWithAnnotation:self reuseIdentifier:@"current_node"];
            }
            view.image = [UIImage imageNamed:@"icon_current"];
        }
            break;
        default:
            break;
